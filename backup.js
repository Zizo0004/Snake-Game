       ...
       sectioninfo = window.getComputedStyle(document.getElementById(lenDict[i]))
           ...
           switch(dict[lenDict[i]]){
               case "UP":
                   if(i==0){
                       if(tracker == "UP"){
                           if(sectioninfo.left != head.left){section.style.left = `${parseInt(sectioninfo.left.replace(/px/g,""))+5}px`}
                           else{section.style.top  = `${parseInt(sectioninfo.top.replace(/px/g,""))-5}px`; dict[lenDict[i]] = "UP"}
                       }
                           ...
                           section.style.left = `${parseInt(sectioninfo.left.replace(/px/g,""))+5}px`
                       }
                   }
                       ...
                       if(dict[lenDict[i-1]] == "UP"){
                           if(sectioninfo.left != nextsectioninfo.left){section.style.left = `${parseInt(sectioninfo.left.replace(/px/g,""))+5}px`}
               ...
               case "RIGHT":
                   if(i==0){
                       if(tracker == "UP"){
                           if(sectioninfo.left != head.left){console.log(`head: ${head.left}, tail : ${sectioninfo.left}`);section.style.left = `${parseInt(sectioninfo.left.replace(/px/g,""))+5}px`}
                           else{console.log("else statemtn");section.style.top  = `${parseInt(sectioninfo.top.replace(/px/g,""))-5}px`; dict[lenDict[i]] = "UP"}
                       }
                       ...
                       if(dict[lenDict[i-1]] == "UP"){
                           ...
                           if(sectioninfo.left != head.left){section.style.left = `${parseInt(sectioninfo.left.replace(/px/g,""))+14}px`}
                           else{section.style.top  = `${parseInt(sectioninfo.top.replace(/px/g,""))+14}px`; dict[lenDict[i]] = "UP"}
                       }
                       else if (dict[lenDict[i-1]] == "RIGHT"){
                           section.style.left = `${parseInt(sectioninfo.left.replace(/px/g,""))+5}px`
                       }
               ...
               case "UP":
                   if(i==0){
                       if(tracker == "UP"){
                           ...
                           if(sectioninfo.left != head.left){section.style.left = `${parseInt(sectioninfo.left.replace(/px/g,""))+5}px`}
                           else{section.style.top  = `${parseInt(sectioninfo.top.replace(/px/g,""))+5}px`; dict[lenDict[i]] = "DOWN"}
                       }
                       else if (tracker == "RIGHT"){
                           
                           if(sectioninfo.top != head.top){section.style.top = `${parseInt(sectioninfo.top.replace(/px/g,""))-5}px`}
                           else{section.style.left = `${parseInt(sectioninfo.left.replace(/px/g,""))+5}px`; dict[lenDict[i]] = "RIGHT"}
                       }
                   }
                   else{
                       nextsectioninfo = window.getComputedStyle(document.getElementById(lenDict[i-1]))
                       ...
                       if(dict[lenDict[i-1]] == "UP"){
                           ...
                           if(sectioninfo.top != nextsectioninfo.top){section.style.top = `${parseInt(sectioninfo.top.replace(/px/g,""))-5}px`}
                           else{section.style.left = `${parseInt(sectioninfo.left.replace(/px/g,""))+5}px`; dict[lenDict[i]] = "RIGHT"}
                       }
               ...
               case "RIGHT":
                   if(i==0){
                       if(tracker == "UP"){
                           ...
                           if(sectioninfo.top != head.top){section.style.top = `${parseInt(sectioninfo.top.replace(/px/g,""))-5}px`}
                           else{section.style.left = `${parseInt(sectioninfo.left.replace(/px/g,""))+5}px`;
                           console.log(`${parseInt(head.left.replace(/px/g,"")) - parseInt(sectioninfo.left.replace(/px/g,""))}`);
                           console.log(head.left,sectioninfo.left);
                       ...
                       nextsectioninfo = window.getComputedStyle(document.getElementById(lenDict[i-1]))
                       if(dict[lenDict[i-1]] == "UP"){
                           if(sectioninfo.left != nextsection.left){section.style.left = `${parseInt(sectioninfo.left.replace(/px/g,""))+5}px`}
                           else{section.style.top  = `${parseInt(sectioninfo.top.replace(/px/g,""))-5}px`; dict[lenDict[i]] = "UP"}
                       }
